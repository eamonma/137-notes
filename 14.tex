    ...
    \item Write \(f(x) = \frac{1}{x}\) as a power series at \(3\) \\
          Change of variable \fbox{\(u = x - 3\)} \begin{align*}
              \frac{1}{x} & = \frac{1}{u+3} \qquad \br{\frac{1}{1-x} = \sum_{n = 0}^{\infty} x^n \quad \text{ for } \abs{x} < 1}                    \\
                          & = \frac{1}{3} \cdot \frac{1}{1 + (u/3)} = \frac{1}{3} \cdot \frac{1}{1-(-u/3)} = \frac{1}{3} \sum_{n = 0}^{\infty} (-\frac{u}{3})^n \\
...
\begin{itemize}
    ...
    \item Option 2: Write \(f(x) = \ln (1+x)\) as power series at \(0\) .
        \begin{align*}
...
P_4 (\frac{1}{2}) = \sum_{k = 0}^{4} \frac{1}{k! 2^k} = \dots = \frac{211}{128} \approx 1.64843\dots
\end{align*}
...
\begin{itemize}
    ...
    \item Since there is no domain restriction, we replace \(x\) with \(-x^2\). \begin{align*}
            e^{-x^2} &= \sum_{n = 0}^{\infty} \frac{(-x^2)^{n}}{n!} \sum_{n=0}^{\infty} \frac{(-1)^{n}}{n!} x^{2n} \qquad \text{for all } x \\
            I &= \int_{0}^{3} \frac{(-1)^{n}}{n!} x^{2n} dx = \sum_{n=0}^{\infty} \frac{(-1)^{n}}{n!} \int_{0}^{3} x^{2n} dx  \\
              &= \sum_{n=0}^{\infty} \frac{(-1)^{n}}{n!} x^{2n+1} \evalu{x=0}{x=3} = \sum_{n=0}^{\infty} \frac{(-1)^{n}3^{2n+1}}{n! (2n+1)}
    \end{align*}
\end{itemize}
\eg 2: $\int \frac{1}{1-x^{8}}dx$
\begin{align*}
    \int \frac{1}{1-x^{8}} dx = \int \sum_{n=0}^{\infty} x^{8n}dx = \sum_{n=0}^{\infty} \frac{x^{8n+1}}{8n+1} + C \quad \text{valid when } \abs{x} < 1
\end{align*}
...
\begin{itemize}
    ...
    \begin{align*}
    x\sin x - \ln (1+x^2) = {\color{red} \sbr{1 - 1}x^2 } + {\color{blue} \sbr{-1\frac{1}{6} + \frac{1}{2}} x^4 } + \dots = \frac{1}{3} x^4 + \text{higher order terms}
    \end{align*}
\end{itemize}
\begin{align*}
& \lim_{x \to 0} \frac{3x^2 - e^{x^2} + \cos (2x)}{x\sin x - \ln (1+x^2)}\\
